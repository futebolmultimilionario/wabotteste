<?php
        $APIurl = 'https://eu107.chat-api.com/instance145368/';
        $token = 'p2fsxsdsnd8d8c92';
	$APIurl2 = 'https://eu107.chat-api.com/instance145367/';
        $token2 = 'c08ujrmh45sx161z';
	...
	$autor = $updateArray["messages"][0]["author"];
        ...
        $chatIdCariocaJP = "558398858522-1568030251@g.us";
	...
	$chatIdBuritypsJP = "558399711150-1590499962@g.us";
        $chatIdCarioca = "557199039262-1591003488@g.us";
