<?php
        $APIurl = 'https://eu127.chat-api.com/instance165994/';
        $token = 'oq35qit8wwchnobs';
	$APIurl2 = 'https://eu127.chat-api.com/instance165997/';
        $token2 = '0ht8zknh7byukye6';
	...
	ob_start();
		...
		$text2 = strstr($text2, 'MarioBetsPRO:');
